...
Clone The Repository Or Download The `.toml` File To A Directory Of Your Choice. Then, Include The Inferno Color Scheme In Your `alacritty.toml` By Adding The Following Import:

```
import = [ "https://github.com/Stallone2K/alacritty.config/blob/Main/inferno.toml" ]
```
